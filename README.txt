This modules allows addition values of taxonomy type fields of an entity as classes in the body element, on the entity's page. It adds the settings per field instance, hence you can enable body classes for individual fields per entity type and not for a field in all entity types.
...
How to set up -
* for the taxonomy field which you want as body classes, edit the field settings for the content type
